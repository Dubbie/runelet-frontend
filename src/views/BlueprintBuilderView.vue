...
import { IconLink, IconPencil, IconPlus } from '@tabler/icons-vue'
    ...
    <div class="max-w-5xl mx-auto px-4">
      ...
      <div class="mb-3">
        ...
        <textarea
          ...
          class="w-full h-24 bg-white/5 p-3 rounded-md border border-zinc-700 focus:outline-none focus:ring-2 focus:ring-yellow-500"
        ></textarea>
      </div>
